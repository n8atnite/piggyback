  ...
  return (
    <Container> 
      <Box sx={{
        ...
        <MainBar/>
        <Product name='random sticker pack (1)' price={2} imgurl='https://images.unsplash.com/photo-1500576992153-0271099def59?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80' />
